 ...
 * @author M_Samly
 */
public class incomedaybyday extends javax.swing.JInternalFrame {

    /**
     * Creates new form incomemonth
     */
    public incomedaybyday() {
        initComponents();
    ...
    public ArrayList<incomeDayByDayCode> incomeList() {
        ArrayList<incomeDayByDayCode> incomeList = new ArrayList<>();
        try {
            Connection con;
            Statement st;
            con = db.getConnection();
            st = con.createStatement();
            String query = "SELECT date, SUM(income) AS income FROM product_income WHERE year = YEAR(CURDATE()) GROUP BY date ORDER BY date";
            ResultSet rs = st.executeQuery(query);
            incomeDayByDayCode pro;
            while (rs.next()) {
                pro = new incomeDayByDayCode(rs.getString("date"), rs.getFloat("income"));
                incomeList.add(pro);
            }
        } catch (Exception e) {
    ...
    public void show_Income() {
        ArrayList<incomeDayByDayCode> list = incomeList();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Serach By Date");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            MessageFormat header = new MessageFormat("Daily Income: ");
    ...
    private void txtproductKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtproductKeyReleased
        // TODO add your handling code here:
        ArrayList<incomeDayByDayCode> al = new ArrayList<incomeDayByDayCode>();
        ...
        try {
            ...
            con = db.getConnection();
            st = con.createStatement();
            String query = "Select date, SUM(income) AS income from product_income where date like '" + val + "%' AND year = YEAR(CURDATE()) GROUP BY date ORDER BY date";
            ResultSet rs = st.executeQuery(query);
            incomeDayByDayCode pro;
            while (rs.next()) {
                pro = new incomeDayByDayCode(rs.getString("date"), rs.getFloat("income"));
