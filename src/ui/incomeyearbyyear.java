...
import code.incomeYearByYearCode;
import database.db;
 ...
 * @author M_Samly
 */
public class incomeyearbyyear extends javax.swing.JInternalFrame {

    /**
     * Creates new form incomemonth
     */
    public incomeyearbyyear() {
        initComponents();
    ...
    public ArrayList<incomeYearByYearCode> incomeList() {
        ArrayList<incomeYearByYearCode> incomeList = new ArrayList<>();
        try {
            Connection con;
            Statement st;
            con = db.getConnection();
            st = con.createStatement();
            String query = "SELECT year, SUM(income) AS income FROM product_income GROUP BY year ORDER BY year";
            ResultSet rs = st.executeQuery(query);
            incomeYearByYearCode pro;
            while (rs.next()) {
                pro = new incomeYearByYearCode(rs.getString("year"), rs.getFloat("income"));
                incomeList.add(pro);
            }
        } catch (Exception e) {
    ...
    public void show_Income() {
        ArrayList<incomeYearByYearCode> list = incomeList();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Serach By Year");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            MessageFormat header = new MessageFormat("Yearly Income: ");
            MessageFormat footer = new MessageFormat("Page{0, number, integer}");
            String data[] = {};
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.addRow(data);
            String data1[] = {"", "", "Yearly Income", txtIncome.getText()};
    ...
    private void txtproductKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtproductKeyReleased
        // TODO add your handling code here:
        ArrayList<incomeYearByYearCode> al = new ArrayList<incomeYearByYearCode>();
        ...
        try {
            ...
            con = db.getConnection();
            st = con.createStatement();
            String query = "Select year, SUM(income) AS income from product_income where year like '" + val + "%' GROUP BY year ORDER BY year";
            ResultSet rs = st.executeQuery(query);
            incomeYearByYearCode pro;
            while (rs.next()) {
                pro = new incomeYearByYearCode(rs.getString("year"), rs.getFloat("income"));
